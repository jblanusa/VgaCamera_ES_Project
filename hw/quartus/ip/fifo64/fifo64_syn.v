...
//a_gray2bin device_family="Cyclone V" WIDTH=7 bin gray
...
module  fifo64_a_gray2bin
	...
	assign
		...
		xor4 = (gray[4] ^ xor5),
		xor5 = (gray[6] ^ gray[5]);
endmodule //fifo64_a_gray2bin


//a_graycounter DEVICE_FAMILY="Cyclone V" PVALUE=1 WIDTH=7 aclr clock cnt_en q
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sub_parity7a[1:1] <= 1'b0;
			...
			else  sub_parity7a[1:1] <= ((cnt_en & counter5a[6]) | ((~ cnt_en) & sub_parity7a[1:1]));
	assign
		...
		sclr = 1'b0,
		updown = 1'b1;
endmodule //fifo64_a_graycounter


//a_graycounter DEVICE_FAMILY="Cyclone V" PVALUE=1 WIDTH=7 aclr clock cnt_en q ALTERA_INTERNAL_OPTIONS=suppress_da_rule_internal=S102
//VERSION_BEGIN 16.0 cbx_a_gray2bin 2016:04:27:18:05:34:SJ cbx_a_graycounter 2016:04:27:18:05:34:SJ cbx_cycloneii 2016:04:27:18:05:34:SJ cbx_mgl 2016:04:27:18:06:48:SJ cbx_stratix 2016:04:27:18:05:34:SJ cbx_stratixii 2016:04:27:18:05:34:SJ  VERSION_END
...
`endif
	...
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) sub_parity10a[1:1] <= 1'b0;
			...
			else  sub_parity10a[1:1] <= ((cnt_en & counter8a[6]) | ((~ cnt_en) & sub_parity10a[1:1]));
	assign
		...
		sclr = 1'b0,
		updown = 1'b1;
endmodule //fifo64_a_graycounter1
...
`endif
	...
	cyclonev_ram_block   ram_block11a_16
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_16.lpm_type = "cyclonev_ram_block";
	cyclonev_ram_block   ram_block11a_17
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_17.lpm_type = "cyclonev_ram_block";
	cyclonev_ram_block   ram_block11a_18
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_18.lpm_type = "cyclonev_ram_block";
	cyclonev_ram_block   ram_block11a_19
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_19.lpm_type = "cyclonev_ram_block";
	cyclonev_ram_block   ram_block11a_20
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_20.lpm_type = "cyclonev_ram_block";
	cyclonev_ram_block   ram_block11a_21
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_21.lpm_type = "cyclonev_ram_block";
	cyclonev_ram_block   ram_block11a_22
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_22.lpm_type = "cyclonev_ram_block";
	cyclonev_ram_block   ram_block11a_23
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_23.lpm_type = "cyclonev_ram_block";
	cyclonev_ram_block   ram_block11a_24
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_24.lpm_type = "cyclonev_ram_block";
	cyclonev_ram_block   ram_block11a_25
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_25.lpm_type = "cyclonev_ram_block";
	cyclonev_ram_block   ram_block11a_26
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_26.lpm_type = "cyclonev_ram_block";
	cyclonev_ram_block   ram_block11a_27
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_27.lpm_type = "cyclonev_ram_block";
	cyclonev_ram_block   ram_block11a_28
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_28.lpm_type = "cyclonev_ram_block";
	cyclonev_ram_block   ram_block11a_29
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_29.lpm_type = "cyclonev_ram_block";
	cyclonev_ram_block   ram_block11a_30
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_30.lpm_type = "cyclonev_ram_block";
	cyclonev_ram_block   ram_block11a_31
	( 
	.clk0(clock0),
	.clk1(clock1),
	.clr1(aclr1),
	...
	defparam
		...
		ram_block11a_31.lpm_type = "cyclonev_ram_block";
	assign
...
`endif
	...
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		if (prn == 1'b0) dffe13a <= {7{1'b1}};
		else if (clrn == 1'b0) dffe13a <= 7'b0;
		else if  (ena == 1'b1)   dffe13a <= (d & {7{(~ sclr)}});
	// synopsys translate_off
	initial
		dffe14a = 0;
	// synopsys translate_on
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		...
		else if  (ena == 1'b1)   dffe14a <= (dffe13a & {7{(~ sclr)}});
	assign
		ena = 1'b1,
		prn = 1'b1,
		q = dffe14a,
		sclr = 1'b0;
endmodule //fifo64_dffpipe
...
`endif
	...
	wire  [6:0]   wire_dffpipe12_q;

	fifo64_dffpipe   dffpipe12
	( 
	.clock(clock),
	.clrn(clrn),
	.d(d),
	...
	assign
		q = wire_dffpipe12_q;
endmodule //fifo64_alt_synch_pipe
...
`endif
	...
	always @ ( posedge clock or  negedge prn or  negedge clrn)
		...
		else if  (ena == 1'b1)   dffe15a <= (d & {7{(~ sclr)}});
	assign
		ena = 1'b1,
		prn = 1'b1,
		q = dffe15a,
		sclr = 1'b0;
endmodule //fifo64_dffpipe1
...
`endif
	...
	assign
		q = wire_dffpipe16_q;
endmodule //fifo64_alt_synch_pipe1


//lpm_add_sub DEVICE_FAMILY="Cyclone V" LPM_DIRECTION="SUB" LPM_WIDTH=7 dataa datab result
...
//lpm_compare DEVICE_FAMILY="Cyclone V" LPM_WIDTH=7 aeb dataa datab
...
endmodule //fifo64_cmpr

//synthesis_resources = lut 8 M10K 1 reg 83 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF;REMOVE_DUPLICATE_REGISTERS=OFF;SYNCHRONIZER_IDENTIFICATION=OFF;SYNCHRONIZATION_REGISTER_CHAIN_LENGTH = 2;suppress_da_rule_internal=d101;suppress_da_rule_internal=d102;suppress_da_rule_internal=d103;-name CUT ON -from rdptr_g -to ws_dgrp|fifo64_dffpipe12:dffpipe16|dffe17a;-name SDC_STATEMENT \"set_false_path -from *rdptr_g* -to *ws_dgrp|fifo64_dffpipe12:dffpipe16|dffe17a* \";-name CUT ON -from delayed_wrptr_g -to rs_dgwp|fifo64_dffpipe:dffpipe12|dffe13a;-name SDC_STATEMENT \"set_false_path -from *delayed_wrptr_g* -to *rs_dgwp|fifo64_dffpipe:dffpipe12|dffe13a* \""} *)
module  fifo64_dcfifo
	( 
	aclr,
	data,
	q,
...
`endif
	...
	fifo64_a_gray2bin   wrptr_g_gray2bin
	( 
	.bin(wire_wrptr_g_gray2bin_bin),
	.gray(wrptr_g[6:0]));
	fifo64_a_gray2bin   ws_dgrp_gray2bin
	( 
	.bin(wire_ws_dgrp_gray2bin_bin),
	.gray(wire_ws_dgrp_q[6:0]));
	fifo64_a_graycounter   rdptr_g1p
	( 
	.aclr(aclr),
	.clock(rdclk),
	.cnt_en(valid_rdreq),
	.q(wire_rdptr_g1p_q));
	fifo64_a_graycounter1   wrptr_g1p
	( 
	.aclr(aclr),
	.clock(wrclk),
	.cnt_en(valid_wrreq),
	.q(wire_wrptr_g1p_q));
	fifo64_altsyncram   fifo_ram
	( 
	.aclr1(aclr),
	...
	fifo64_alt_synch_pipe   rs_dgwp
	( 
	.clock(rdclk),
	.clrn((~ aclr)),
	.d(delayed_wrptr_g),
	.q(wire_rs_dgwp_q));
	fifo64_dffpipe1   ws_brp
	( 
	.clock(wrclk),
	.clrn((~ aclr)),
	.d(wire_ws_dgrp_gray2bin_bin),
	.q(wire_ws_brp_q));
	fifo64_dffpipe1   ws_bwp
	( 
	.clock(wrclk),
	.clrn((~ aclr)),
	.d(wire_wrptr_g_gray2bin_bin),
	.q(wire_ws_bwp_q));
	fifo64_alt_synch_pipe1   ws_dgrp
	( 
	.clock(wrclk),
	.clrn((~ aclr)),
	.d(rdptr_g),
	...
	assign
		...
		rdptr_gs = {(~ rdptr_g[6]), (~ rdptr_g[5]), rdptr_g[4:0]},
...
`endif
	...
	fifo64_dcfifo	fifo64_dcfifo_component (
				.aclr (aclr),
				.data (data),
				.rdclk (rdclk),
				.rdreq (rdreq),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL fifo64_syn.v TRUE
